...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t]);return r.default=e,r}Object.defineProperty(exports,"__esModule",{value:!0}),exports.versions=exports.ssp=exports.player=void 0;var _SSPProtectionController=require("./otv/player/dashjs/SSPProtectionController.js"),_SSPLicenseFormatter=require("./otv/ssp/SSPLicenseFormatter.js"),SSPLicenseFormatter=_interopRequireWildcard(_SSPLicenseFormatter),_buildVersion=require("../dist/buildVersion.json"),buildDetails=_interopRequireWildcard(_buildVersion),versions={product:buildDetails.product,buildNumber:buildDetails.number,buildType:buildDetails.type},player={dashjs:{SSPProtectionController:_SSPProtectionController.SSPProtectionController}},ssp={SSPLicenseFormatter:SSPLicenseFormatter};exports.player=player,exports.ssp=ssp,exports.versions=versions;
...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var s in e)Object.prototype.hasOwnProperty.call(e,s)&&(t[s]=e[s]);return t.default=e,t}function SSPProtectionController(e){function t(e){var t=null,s=e.systemString;return m&&(t=s in m?m[s]:null),t}function s(e){S(e),m=e}function r(e){var t=d.on;d.on=function(e,s,r,n){"internalKeyMessage"!==e&&t(e,s,r,n)},f(e),d.on=t,e?(l.setMediaElement(e),d.on("internalKeyMessage",p),d.on("public_keySystemSelected",u)):null===e&&(l.setMediaElement(e),d.off("internalKeyMessage",p),d.off("public_keySystemSelected",u))}function n(e,t){d.trigger("public_licenseRequestComplete",{data:e,error:t})}function o(e,t,s,r){if(e.status===HTTP_SUCCESS){n(t);var o=LicenseFormatter.unpackageLicense(e.response);l.updateKeySession(t.sessionToken,s.getLicenseMessage(o,r,t.messageType))}else n(t,"DRM: "+r+' update, XHR status is "'+e.statusText+'" ('+e.status+"), expected to be 200. readyState is "+e.readyState+".  Response is "+(e.response?s.getErrorResponse(e.response,r,t.messageType):"NONE"))}function a(e,t){if(t&&t.httpRequestHeaders)for(var s in t.httpRequestHeaders)t.httpRequestHeaders.hasOwnProperty(s)&&e.setRequestHeader(s,t.httpRequestHeaders[s])}function i(e,t){if(e.serverURL){var s=e.serverURL;if("string"==typeof s&&""!==s)return s;if("object"===(void 0===s?"undefined":_typeof(s))&&s.hasOwnProperty(t))return s[t]}return null}function u(e){e&&e.data&&(g=e.data.keySystem)}function p(e){if(y("DRM: onKeyMessage"),e.error)return void y(e.error);var s=e.data;d.trigger("public_keyMessage",{data:s});var r=s.messageType?s.messageType:"license-request",u=s.message,p=s.sessionToken,l=t(g),f=g.systemString,S=c.getLicenseServer(g,l,r),m={sessionToken:p,messageType:r};if(!S)return y("DRM: License server request not required for this message (type = "+e.data.messageType+").  Session ID = "+p.getSessionID()),void n(m);var v,R=new XMLHttpRequest;if(v=l?i(l,r):e.data.laURL,!(v=S.getServerURLFromMessage(v,u,r)))return void n(m,"DRM: No license server URL specified!");R.open(S.getHTTPMethod(r),v,!0),R.responseType=S.getResponseType(f,r),R.onload=function(){o(this,m,S,f)},R.onabort=function(){n(m,"DRM: "+f+' update, XHR aborted. status is "'+this.statusText+'" ('+this.status+"), readyState is "+this.readyState)},R.onerror=function(){n(m,"DRM: "+f+' update, XHR error. status is "'+this.statusText+'" ('+this.status+"), readyState is "+this.readyState)},a(R,l),"com.widevine.alpha"===f?R.send(LicenseFormatter.packagePayload(u)):R.send(g.getLicenseRequestFromMessage(u))}var c=e.protectionKeyController,l=e.protectionModel,d=e.eventBus,y=e.log,f=this.parent.setMediaElement,S=this.parent.setProtectionData,g=void 0,m=void 0;return{setMediaElement:r,setProtectionData:s}}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};exports.SSPProtectionController=SSPProtectionController;var _SSPLicenseFormatter=require("../../ssp/SSPLicenseFormatter"),LicenseFormatter=_interopRequireWildcard(_SSPLicenseFormatter),HTTP_SUCCESS=200;

},{"../../ssp/SSPLicenseFormatter":301}],301:[function(require,module,exports){
"use strict";function _toConsumableArray(r){if(Array.isArray(r)){for(var a=0,e=Array(r.length);a<r.length;a++)e[a]=r[a];return e}return Array.from(r)}function unpackageLicense(r){var a=r;try{var e=String.fromCharCode.apply(String,_toConsumableArray(new Uint8Array(r))),n=JSON.parse(e);a=Uint8Array.from(atob(n.license[0]),function(r){return r.charCodeAt(0)})}catch(r){}return a}function packagePayload(r){return'{"challenge":"'+btoa(String.fromCharCode.apply(String,_toConsumableArray(new Uint8Array(r))))+'"}'}Object.defineProperty(exports,"__esModule",{value:!0}),exports.packagePayload=exports.unpackageLicense=void 0,require("babel-polyfill"),exports.unpackageLicense=unpackageLicense,exports.packagePayload=packagePayload;
